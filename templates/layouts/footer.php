            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        <li><a href="<?= APP_URL ?>/category/1">Politics</a></li>
                        <li><a href="<?= APP_URL ?>/category/2">Business</a></li>
                        <li><a href="<?= APP_URL ?>/category/3">Sports</a></li>
                        <li><a href="<?= APP_URL ?>/category/4">Technology</a></li>
                    </ul>
                </div>
                <div class="footer-col">
                    <h4>Subscribe</h4>
