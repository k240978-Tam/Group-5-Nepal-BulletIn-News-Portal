...
<div class="dashboard-layout">
    <?php require_once ROOT_PATH . '/admin/includes/sidebar.php'; ?>
    ...
    <div class="profile-body">
        ...
        <div style="display:flex; gap:.75rem; margin-bottom:2rem; flex-wrap:wrap;">
            ...
            <a href="<?= \App\Core\App::get('config')['url'] ?>/logout" class="action-btn btn-logout" style="margin-left:auto;"><i class="fas fa-sign-out-alt"></i> Logout</a>
        </div>
        ...
        <?php if (count($comments) > 0): ?>
            ...
            <div class="comment-card">
                ...
                <div style="margin-bottom:.3rem;">
                    ...
                    <a href="<?= \App\Core\App::get('config')['url'] ?>/article?id=<?= $c['article_id'] ?>" class="art-link"><?= htmlspecialchars($c['title']) ?></a>
                </div>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <a href="<?= \App\Core\App::get('config')['url'] ?>/" class="action-btn btn-dash" style="display:inline-flex;margin-top:.5rem;"><i class="fas fa-newspaper"></i> Browse Articles</a>
            </div>
        <?php endif; ?>
